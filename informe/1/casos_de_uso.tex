\chapter{Casos de uso} %[PANCHO] breve introduccion? A continuacion se detallan bla bla bla. Separa los casos un poco mas, a  simple vista no se distingue donde empiexa uno y termina otro
