\section{Módulo de registración}
	...
	utilizando únicamente la información de geometría de los mismos. \TODO{real-time 3d model adquisition}
	...
	\begin{enumerate}
		...
		\item Calcular una transformación que minimice la distancia entre estas correspondencias.  \TODO{generalized icp}
	\end{enumerate}
	...
	\TODO{a method for registration}
	...
	\begin{figure}
		...
		\caption{\label{fig:error_bucle}\TODO{imagen error bucle, in-hand...}}
	\end{figure}

	\begin{figure}
		\Imagen{example-image-a}
		\caption{\label{fig:flow_registracion}\TODO{Diagrama de flujo de la registración.} \TODO{flechas de interacción}}
	\end{figure}
	...
	\subsection{Diagrama de clases}
		...
		\begin{figure}
			...
			\caption{\label{fig:align_class}Diagrama de clases del módulo de registración\TODO{actualizar}}
		\end{figure}
				...
				\begin{algorithmic}[1]
					\Function{ISS Keypoints}{nube, $r_1$, $\mbox{umbral}_1$, $\mbox{umbral}_2$, $r_2$}
						...
						\ForAll{$p \in \mbox{nube.puntos}$}
							...
							\EndIf
						\EndFor
						\State\Return Non-Max Suppression(keypoints, $r_2$) \TODO{¿y esto qué es?}
					\EndFunction
				\end{algorithmic}
	...
	\subsection{Alineación mediante búsqueda de clúster}
		...
		\TODO{gráfico} \TODO{expandir}

		Para establecer las correspondencias se utilizó el descriptor FPFH
		comparando los histogramas mediante la distancia $\chi^2$. \TODO{escribir fórmula}
		Luego se
		...
		\begin{figure}
			...
			de puntos de las correspondencias.} \TODO{rehacer gráfico}
		\end{figure}
		...
		\subsection{Resultados}
			...
			$90^{\circ}$ respecto a su anterior y siguiente. \TODO{no ignorar, explicar que está fuera de rango}
			Las otras
		...
		\begin{figure}
			...
			\caption{\label{fig:clust_bunny}Diferencias absolutas entre la rotación estimada y el \emph{ground truth} para el objeto \texttt{bunny}.}\TODO{rehacer}
		\end{figure}

		\begin{figure}
			\Imagen{img/cluster_happy}
			\caption{\label{fig:clust_happy}Diferencias absolutas entre la rotación estimada y el \emph{ground truth} para el objeto \texttt{happy}.}\TODO{rehacer, ajustar escala}
		\end{figure}

		\begin{figure}
			\Imagen{img/bun_clust_270_315}
			\caption{\label{fig:clust_bun_good}Alineación exitosa entre las capturas \texttt{bun270} (verde) y \texttt{bun316} (rojo) mediante el uso de marcos de referencia en cada punto.} \TODO{Juntar con la de SAC-IA}
		\end{figure}


	\section{Refinamiento}
	\TODO{rehacer la redacción}
	...
	\TODO{expandir, ICP con normales}
	...
	\TODO{pseudocódigo, ¿resultados?}
	\TODO{fórmulas de interpolación: translación+rotación(cuaternión)}
	
	\TODO{tengot resultados parciales acá, ¿los muevo?}
