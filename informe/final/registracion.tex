\section{Módulo de registración}
	...
	\subsection{Alineación mediante búsqueda de clúster}
		...
		el eje $y$ y una translación en el plano $xz$, observándose agrupaciones (\emph{clústers})
		de los parámetros de estas transformaciones (figura~\ref{fig:cluster}).
		La transformación de alineación final se corresponde con el centroide del clúster más grande,
		cuya estimación se realiza mediante el algoritmo de k-means\cite{Xu05surveyof}.
