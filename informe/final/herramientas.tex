...
\section{Tecnologías}
	...
	%TODO: explicitar por qué no todas se usaron, pero que se consideraron,
	%analizaron y descartaron por algún motivo

	\subsection{KinectFusion}
	%TODO: ¿algoritmo o biblioteca?
	%algoritmo, incluído en la sdk de kinect v2
