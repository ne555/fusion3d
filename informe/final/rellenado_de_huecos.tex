\section{Módulo de rellenado de huecos}
	...
	%Entre las ventajas de esta formulación podemos citar:
	%\begin{itemize}
	...
	%	\item Permite usar funciones de soporte local para aproximar $\chi$,
	%		produciendo un sistema lineal bien condicionado y ralo.
	%\end{itemize}


	\subsubsection{Implementación}
	%Poisson
	La clase \texttt{pcl::Poisson} provee algoritmos de reconstrucción basados en \cite{Kazhdan:2006:PSR:1281957.1281965}, %cite Poisson surface reconstruction
