\chapter{Pruebas y resultados}
    ...
    Para independizarse del tamaño de los modelos, se normalizó respecto a la resolución de la nube,
    definida en el algoritmo~\ref{alg:resolución_de_nube} (página~\pageref{alg:resolución_de_nube}).
