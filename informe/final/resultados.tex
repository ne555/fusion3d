...
%del capítulo de desarrollo
	...
	donde los ángulos eran cercanos a $25^{\circ}$ (figura~\ref{fig:sac_angles}). \TODO{mentira, falló en una con happy}
	...
	\begin{figure}
		...
		\Imagen{foo}
		\caption[Diferencias en la rotación estimada para el objeto \texttt{happy}]{\label{fig:sac_angles}\TODO{Diferencias entre la rotación estimada mediante \emph{sample consensus} y el \emph{ground truth} para el objeto \texttt{happy}}}
	\end{figure}
...
\begin{figure}
	...
	\caption[Diferencias en la rotación estimada para el objeto \texttt{bunny}]{\label{fig:clust_happy}Diferencias absolutas entre la rotación estimada y el \emph{ground truth} para el objeto \texttt{happy}.}
\end{figure}
