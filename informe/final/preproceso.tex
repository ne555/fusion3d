...
\end{algorithm}
	...
	\item Para reducir las pequeñas perturbaciones en las posiciones de los puntos,
        se los proyecta a una superficie estimada mediante el método de mínimos cuadrados móviles. %TODO: gráfico explicativo (para las diapos)
	...
	\item Para evitar las distorsiones debidas al ángulo de incidencia excesivo,
		...
		Luego se eliminan los puntos cuyas normales se encontraban a más de $80^{\circ}$ del eje $z$. %TODO: gráfico explicativo (para las diapos)
	...
	\item Se eliminan aquellos puntos que puedan ser producto de distorsiones debidas al reflejo parcial,
		...
		\begin{itemize}
			...
			\item Los puntos buscados son aquellos que delimitan bordes en la malla o se encuentran aislados.   %TODO: gráfico explicativo (para las diapos)
		\end{itemize}
\end{itemize}
